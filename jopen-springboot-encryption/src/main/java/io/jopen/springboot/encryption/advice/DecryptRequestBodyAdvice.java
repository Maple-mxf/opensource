package io.jopen.springboot.encryption.advice;

import io.jopen.springboot.encryption.annotation.decrypt.AESDecryptBody;
import io.jopen.springboot.encryption.annotation.decrypt.DESDecryptBody;
import io.jopen.springboot.encryption.annotation.decrypt.DecryptBody;
import io.jopen.springboot.encryption.annotation.decrypt.RSADecryptBody;
import io.jopen.springboot.encryption.bean.DecryptAnnotationInfoBean;
import io.jopen.springboot.encryption.bean.DecryptHttpInputMessage;
import io.jopen.springboot.encryption.config.EncryptBodyConfig;
import io.jopen.springboot.encryption.enums.DecryptBodyMethod;
import io.jopen.springboot.encryption.exception.DecryptBodyFailException;
import io.jopen.springboot.encryption.exception.DecryptMethodNotFoundException;
...
import io.jopen.springboot.encryption.util.CheckUtils;
import io.jopen.springboot.encryption.util.DesCipherUtil;
import io.jopen.springboot.encryption.util.StringUtils;
 ...
 *     以及package为<strong><code>cn.licoy.encryptbody.io.jopen.springboot.encryption.annotation.decrypt</code></strong>下的注解有效
...
public class DecryptRequestBodyAdvice implements RequestBodyAdvice {
    ...
    public HttpInputMessage beforeBodyRead(HttpInputMessage inputMessage, MethodParameter parameter, Type targetType, Class<? extends HttpMessageConverter<?>> converterType) throws IOException {
        ...
        try {
            ...
            throw new DecryptBodyFailException("The string is converted to a stream format io.jopen.springboot.encryption.exception." +
    ...
    private String switchDecrypt(String formatStringBody,DecryptAnnotationInfoBean infoBean){
        ...
        if(method == DecryptBodyMethod.DES){
            ...
            return DesCipherUtil.decrypt(formatStringBody,key);
        }
