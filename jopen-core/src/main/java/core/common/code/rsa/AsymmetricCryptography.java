...
public class AsymmetricCryptography {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (new File("KeyPair/text.txt").exists()) {
            ...
            String encryptText = ac.encryptText(Json.of("k", "v").toString(), privateKey);

            System.err.println(encryptText);

            String decryptText = ac.decryptText(encryptText, publicKey);

            System.err.println(decryptText);

        } else {

            System.err.println("Create a file text.txt under folder KeyPair");
        }
    }
}
