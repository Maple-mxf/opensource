...
public class BinaryTree<T> extends AbstractBinaryTree<T> {
    ...
    public void createBinaryTree() {
        ...
        BinaryTreeNode B = generateNode(1, "B");
        BinaryTreeNode C = generateNode(2, "C");
        BinaryTreeNode D = generateNode(3, "D");
        BinaryTreeNode E = generateNode(4, "E");
        BinaryTreeNode F = generateNode(5, "F");
        BinaryTreeNode G = generateNode(6, "G");
