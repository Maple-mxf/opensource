...
public interface AdvancedDatastore extends Datastore {
     ...
     * @morphia.inline
     * @see WriteConcern
     * @deprecated use {@link #insert(Object, dev.morphia.InsertOptions)}
     */
    @Deprecated
     ...
     * @since 1.3
     */
    <T> Key<T> insert(T entity, dev.morphia.InsertOptions options);
     ...
     */
    @Deprecated
    <T> Key<T> insert(String collection, T entity, dev.morphia.InsertOptions options);
     ...
     * @param <T>      the type of the entity
     * @return the new keys of the inserted entities
     * @deprecated use {@link #insert(Iterable, dev.morphia.InsertOptions)}
     */
    @Deprecated
     ...
     * @since 1.3
     */
    <T> Iterable<Key<T>> insert(Iterable<T> entities, dev.morphia.InsertOptions options);
     ...
     * @return the new keys of the inserted entities
     * @see WriteConcern
     * @deprecated use {@link #insert(String, Iterable, dev.morphia.InsertOptions)} instead
     */
    @Deprecated
     ...
     */
    @Deprecated
    <T> Iterable<Key<T>> insert(String collection, Iterable<T> entities, dev.morphia.InsertOptions options);
     ...
     * @param <T>        the type of the entity
     * @return the new key of the inserted entity
     * @deprecated use {@link #save(String, Object, dev.morphia.InsertOptions)} instead
     */
    @Deprecated
