...
import io.jopen.springboot.plugin.encryption.annotation.encrypt.*;
import io.jopen.springboot.plugin.encryption.bean.EncryptAnnotationInfoBean;
...
import io.jopen.springboot.plugin.encryption.exception.EncryptBodyFailException;
import io.jopen.springboot.plugin.encryption.exception.EncryptMethodNotFoundException;
import io.jopen.springboot.plugin.encryption.util.*;
 ...
 *     以及package为<strong><code>cn.licoy.encryptbody.io.jopen.springboot.encryption.annotation.encrypt</code></strong>下的注解有效
 */
@Order(1)
@ControllerAdvice
@Slf4j
public class EncryptResponseBodyAdvice implements ResponseBodyAdvice {
    ...
    private String switchEncrypt(String formatStringBody,EncryptAnnotationInfoBean infoBean){
        ...
        if(method == EncryptBodyMethod.DES){
            ...
            return DesCipherUtil.encrypt(formatStringBody,key);
        }
