...
public class Formatter {
    ...
    public static String now(String P) {
        return format(LocalDateTime.now(), P);
    }
    ...
    public static String format(Date date, String P) {
        return format(date.getTime(), P);
    }

    public static String format(long timestamp, String P) {
        return format(LocalDateTimeUtil.toLocalDateTime(timestamp), P);
    }

    public static String format(LocalDateTime dateTime, String P) {
